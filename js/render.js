...
const renderproducts = function() {
    ...
    //     console.log("Clicked");
    //     let max = ProductModel.getTotalPage();
    //     index += 1;
    //     if (index <= max) {

    //         console.log(index);
    //         ProductModel.getDocumentsByPage(index).forEach(item => {
    //             let htmlss = `
    //             <li>
    //         <div class="product-items"></div>
    //         <div class="product-top">
    ...
    //     </li>      
    //      `
    //             document.getElementById('products').insertAdjacentHTML("beforeend", htmlss);
    //             document.getElementById("products").style.animation = 'fadeIn ease-in 0.7s';
    ...
    //     } else {
    //         //console.log("dô");
    //         let hidden = document.getElementsByClassName('btn-load')[0];
